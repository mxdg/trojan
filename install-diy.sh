...
DOWNLAOD_URL="https://github.com/mxdg/trojan/releases/download/"

VERSION_CHECK="https://api.github.com/repos/mxdg/trojan/releases/latest"

SERVICE_URL="https://raw.githubusercontent.com/mxdg/trojan/master/asset/trojan-web.service"
